...
var client_model_1 = require("../BusinessLogic/clients/client.model");
...
var AuthenticationController = /** @class */ (function () {
    function AuthenticationController() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        next(new UserWithSameEmailException_1["default"](userData.email));
                        return [3 /*break*/, 5];
                    case 2: return [4 /*yield*/, bcrypt.hash(userData.hash, 10)];
                    case 3:
        ...
        this.loggingIn = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            var logInData, user, isPasswordMatching, userAndToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (isPasswordMatching) {
                            user.hash = "";
                            userAndToken = { user: user, tokenData: this.createToken(user) };
